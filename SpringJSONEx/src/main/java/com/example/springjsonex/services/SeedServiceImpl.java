...
import com.example.springjsonex.entities.categories.Category;
import com.example.springjsonex.entities.categories.CategoryImportDTO;
import com.example.springjsonex.entities.products.Product;
import com.example.springjsonex.entities.products.ProductImportDTO;
import com.example.springjsonex.entities.users.User;
import com.example.springjsonex.entities.users.UserImportDTO;
import com.example.springjsonex.repositories.CategoryRepository;
...
public class SeedServiceImpl implements SeedService{
    ...
    private static final Path USERS_JSON_PATH =
            Path.of("src","main","resources","users.json");
    private static final Path CATEGORIES_JSON_PATH =
            Path.of("src","main","resources","categories.json");
    private static final Path PRODUCTS_JSON_PATH =
            Path.of("src","main","resources","products.json");
