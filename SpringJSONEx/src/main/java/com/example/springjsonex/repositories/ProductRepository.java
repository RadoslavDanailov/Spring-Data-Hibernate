...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query("SELECT new com.example.springjsonex.entities.products.ProductWithoutBuyerDTO(" +
    ...
    @Query("SELECT new com.example.springjsonex.entities.categories.CategoryStatsDTO(" +
