...
import com.example.springdataadvancedquery.entity.*;
...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    List<com.example.springdataadvancedquery.entity.Book> findAllByReleaseDateAfter(LocalDate releaseDateAfter);

    List<com.example.springdataadvancedquery.entity.Book> findAllByReleaseDateBefore(LocalDate releaseDateBefore);
    ...
    List<com.example.springdataadvancedquery.entity.Book> findByPriceLessThanOrPriceGreaterThan(BigDecimal lowerBound, BigDecimal upperBound);

    List<com.example.springdataadvancedquery.entity.Book> findByReleaseDateBeforeOrReleaseDateAfter(LocalDate before, LocalDate after);

    List<Book> findByTitleContaining(String search);

    List<com.example.springdataadvancedquery.entity.Book> findByAuthorLastNameStartingWith(String search);
